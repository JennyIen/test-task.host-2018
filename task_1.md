...
Эта инструкция по работе с MS Word предназначена для начинающих пользователей.
...
3. Воспользуйтесь возможностями группы **Шрифт**, чтобы изменить размер текста и его начертание, а так же задать цвет текста или цветовое выделение.
...
*Нумерация страниц документа необходима для того, чтобы легче ориентироваться в документе.*
...
### Создание оглавления
*Оглавление документа необходимо для того, чтобы увидеть его структуру и легко ориентироваться в документе.*
...
*Гиперссылки в документе необходимы для того, чтобы сослаться на информацию, находяющуюся в другом месте в тексте, а также на файлы на копьютере или в Интернете.*
...
*Изменение размера изображения необходимо для того, чтобы корректно расположить изображение на листе документа.*
...
*Преобразование таблицы необходимо для того, чтобы наглядно показать данные или однотипную информацию.*
